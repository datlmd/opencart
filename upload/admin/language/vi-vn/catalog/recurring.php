...
$_['text_month']			= 'Tháng';
$_['text_year']				= 'Năm';
$_['text_recurring']	    = '<p><i class="fa fa-info-circle"></i> Số tiền định kỳ được tính theo tần số và chu kỳ.</p><p>Ví dụ: nếu bạn sử dụng tần suất "tuần" và chu kỳ "2" thì người dùng sẽ được lập hoá đơn mỗi 2 tuần.</p><p>Thời hạn là số lần người dùng thực hiện thanh toán, đặt giá trị này là 0 nếu bạn muốn thanh toán cho đến khi chúng bị hủy.</p>';
